...
import getCroppedImg from '../Helper/cropImage'; // helper for cropping
...
const AddCandidate = () => {
    ...
    // Signature state (merged input)
    // Mode can be 'upload' or 'type'
    ...
    const validate = () => {
        ...
        // Either candidateCourseName is provided or both candidateDegree and programme must be selected.
        if (!formData.candidateCourseName) {
        if (!formData.candidateDegree)
            tempErrors.candidateDegree = "Degree is required if course name is not provided.";
        if (!formData.programme)
            tempErrors.programme = "Programme is required if course name is not provided.";
        }
    ...
    const handleSubmit = async (e) => {
        ...
        // For signature, use based on selected mode
    ...
    return (
        ...
        <Wrapper>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <InputGroup>
                <Label>Course Name (optional if doesn't exist in the list)</Label>
                <Input
                    type="text"
            ...
            {showSuccessModal && (
                ...
                <SuccessModal>
                    ...
                    <SuccessButton onClick={() => setShowSuccessModal(false)}>Ok</SuccessButton>
                </SuccessModal>
                </ModalOverlay>
            )}
            </Content>
...
`;
    ...
    /* Remove icon positioned at top-left */
    ...
    /* Loading spinner and success modal overlay */
