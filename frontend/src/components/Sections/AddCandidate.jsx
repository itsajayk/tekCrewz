...
import SignaturePad from "react-signature-canvas"; 
    ...
    // Mode can be 'upload', 'type', or 'draw'
        ...
        />
                ...
                {signatureMode === 'upload' ? (
                    ...
                    <SignatureCanvasWrapper>
                        <SignaturePad ref={signaturePadRef} canvasProps={{ width: 300, height: 100, className: 'sigCanvas' }} />
                    </SignatureCanvasWrapper>
                    <SignatureControls>
                        <CropButton onClick={handleSaveDrawing}>Save Drawing</CropButton>
                        <RemoveIcon onClick={removeSignature}>×</RemoveIcon>
                    </SignatureControls>
                    {drawnSignature && (
                        <ImagePreviewWrapper>
                        <ImagePreview src={drawnSignature} alt="Drawn Signature Preview" />
                        <RemoveIcon onClick={removeSignature}>×</RemoveIcon>
                        </ImagePreviewWrapper>
                    )}
                    </>
